    ...
    return (
        <section className='py-20 bg-slate-300 px-1'>
            <div className="container mx-auto">
                <h2 className="text-xl md:text-3xl lg:text-5xl capitalize font-bold text-center mb-20">{productName}</h2>
                <div className='flex flex-col md:flex-row gap-10 items-center md:gap-20 justify-between'>
                    <div className='max-w-[600px]'>
                        ...
                        <Link to={``}><div className="btn btn-secondary mt-5">Add To Cart</div></Link>
                    </div>
